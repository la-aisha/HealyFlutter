...
import 'package:hopital/Screens/Register/RegisterFileMedecin.dart';
import 'package:hopital/Services/apiservice.dart';

class RegisterMedecinInfo extends StatefulWidget {
  final int role_id = 3;
  //RegisterMedecinInfo()
  const RegisterMedecinInfo({super.key, required role_id});
    ...
    return ElevatedButton(
        onPressed: () {
          ...
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => RegisterFileMedecin()));
        },
        style: ButtonStyle(
